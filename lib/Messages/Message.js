...
class Message extends Base {
    ...
    _patch(data) {
        ...
        // Enhanced participant handling for LID groups
        if (this.isGroup) {
            this.participant = data.participant || data.sender || data.key.participant;
            // For LID groups, ensure we have the participant ID
            if (!this.participant && data.key.participant) {
